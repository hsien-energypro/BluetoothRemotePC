# AutoWriter.py
# ENERGY PRO BLE Beacon Remote - Windows Fixed 5576 Test Version
# 重點：控制與配對都固定使用 Major 0x5576，與 Android 已驗證版本一致。
...
APP_TITLE = "ENERGY PRO BLE Remote - Fixed 5576"
...
class App:
    ...
    def fix_all_panels_to_5576(self):
        for p in self.panels:
            ...
            p["zone"] = ZONE
        self.save_panels()
        self.status.set("已把所有面板固定為 Major 5576")
        self.show_home()
    ...
    def show_home(self):
        ...
        tk.Label(
            f,
            text="PC 固定測試版：Major=5576 / Minor=0003",
            bg="#b7cfe9",
            fg="#b00020",
    ...
    def send_universal(self, panel, label, cmd, data):
        ...
        seq = self.next_seq()
        uuid = bytearray([0xFF, 0x00, 0x0F, CONTROL_DEVICE_CODE, seq, cmd])
        for x in data:
